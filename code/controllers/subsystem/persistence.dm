...
/datum/controller/subsystem/persistence/proc/LoadBlogs()
	GLOB.microblog_server.load_server()

/datum/controller/subsystem/persistence/proc/SaveBlogs()
	GLOB.microblog_server.save_server()
