...
/datum/wound/neck/severe
	...
	occur_text = "emits a sharp, wet crunch along the spine"
...
/datum/wound/neck/critical
	...
	examine_desc = "flops limply in a way no head ever should, broken at the neck"
...
/datum/wound/neck/critical/get_examine_description(mob/user)
	return "<span class='deadsay'><b>[victim.p_their(TRUE)] [limb.name] [examine_desc]...</b></span>"
